...
Moreover, the flexibility of this network performing a sequence to sequence prediction allows it to face tasks where more than a single activity is present in the video.
