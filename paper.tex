...
% AMAIA: La primera frase de l'abstract potser no cal, ja que és massa introductoria. L'he comentat i modificat l'abstract
    ...
    %In the later years the applications of deep learning techniques have moved from images to videos due to the increase of computational resources available. 
...
\subsection{Training}
% AMAIA: He mogut la part de training a experiments
...
% AMAIA: La url del repo ja l'he posat a l'abstract.
