...
Figures~\ref{fig:example_results_detect} and~\ref{fig:example_results_classification} shows some examples of classification and temporal localization prediction for some instances of the dataset, showing continuous and smooth segments.
...
\begin{subfigure}[b]{.6\textwidth}
  \centering
\includegraphics[width=0.95\linewidth]{img/results_visualization_classification_1}
\end{subfigure}
\caption{Example of activity classification.}
